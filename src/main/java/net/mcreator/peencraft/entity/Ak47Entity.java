...
import net.mcreator.peencraft.procedures.Ak47ProjectileHitsLivingEntityProcedure;
...
public class Ak47Entity extends AbstractArrow implements ItemSupplier {
	...
	public void onHitEntity(EntityHitResult entityHitResult) {
		...
		Ak47ProjectileHitsLivingEntityProcedure.execute(this.level, this.getX(), this.getY(), this.getZ());
	}
