...
public class VilligaEntity extends Monster {
	...
	public VilligaEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(PeencraftModEntities.VILLIGA.get(), world);
	}

	public VilligaEntity(EntityType<VilligaEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
	...
	public static AttributeSupplier.Builder createAttributes() {
		...
		builder = builder.add(Attributes.ATTACK_KNOCKBACK, 12);
		return builder;
	}
}
