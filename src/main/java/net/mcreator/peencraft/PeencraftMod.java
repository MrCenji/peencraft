 ...
 *
 */
package net.mcreator.peencraft;
...
@Mod("peencraft")
public class PeencraftMod {
	public static final Logger LOGGER = LogManager.getLogger(PeencraftMod.class);
	public static final String MODID = "peencraft";
