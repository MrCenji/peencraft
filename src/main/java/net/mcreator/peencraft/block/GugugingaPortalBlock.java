...
import net.mcreator.peencraft.world.teleporter.GugugingaTeleporter;
import net.mcreator.peencraft.world.teleporter.GugugingaPortalShape;

import java.util.Random;
import java.util.Optional;

public class GugugingaPortalBlock extends NetherPortalBlock {
	public GugugingaPortalBlock() {
	...
	public static void portalSpawn(Level world, BlockPos pos) {
		Optional<GugugingaPortalShape> optional = GugugingaPortalShape.findEmptyPortalShape(world, pos, Direction.Axis.X);
	...
	public BlockState updateShape(BlockState p_54928_, Direction p_54929_, BlockState p_54930_, LevelAccessor p_54931_, BlockPos p_54932_,
		...
		return !flag && !p_54930_.is(this) && !(new GugugingaPortalShape(p_54931_, p_54932_, direction$axis1)).isComplete()
	...
	public void animateTick(BlockState state, Level world, BlockPos pos, Random random) {
		...
		if (random.nextInt(110) == 0)
			world.playSound(null, pos.getX() + 0.5, pos.getY() + 0.5, pos.getZ() + 0.5,
					ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation(("music_disc.stal"))), SoundSource.BLOCKS, 0.5f,
	...
	public void entityInside(BlockState state, Level world, BlockPos pos, Entity entity) {
		if (!entity.isPassenger() && !entity.isVehicle() && entity.canChangeDimensions() && !entity.level.isClientSide() && true) {
			...
			} else if (entity.level.dimension() != ResourceKey.create(Registry.DIMENSION_REGISTRY, new ResourceLocation("peencraft:guguginga"))) {
				entity.setPortalCooldown();
				teleportToDimension(entity, pos, ResourceKey.create(Registry.DIMENSION_REGISTRY, new ResourceLocation("peencraft:guguginga")));
			} else {
				entity.setPortalCooldown();
	...
	private void teleportToDimension(Entity entity, BlockPos pos, ResourceKey<Level> destinationType) {
		entity.changeDimension(entity.getServer().getLevel(destinationType),
				new GugugingaTeleporter(entity.getServer().getLevel(destinationType), pos));
	}
}
