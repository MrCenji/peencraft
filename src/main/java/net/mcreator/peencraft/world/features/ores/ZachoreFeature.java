...
public class ZachoreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("peencraft:zachore", FEATURE,
				new OreConfiguration(ZachoreFeatureRuleTest.INSTANCE, PeencraftModBlocks.ZACHORE.get().defaultBlockState(), 4));
		PLACED_FEATURE = PlacementUtils.register("peencraft:zachore", CONFIGURED_FEATURE, List.of(CountPlacement.of(5), InSquarePlacement.spread(),
