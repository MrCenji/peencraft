...
public class EverythingLeaveDecorator extends LeaveVineDecorator {
	public static final EverythingLeaveDecorator INSTANCE = new EverythingLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("everything_tree_leave_decorator");
