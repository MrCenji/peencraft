...
public class GooFeature extends LakeFeature {
	public static GooFeature FEATURE = null;
	public static Holder<ConfiguredFeature<LakeFeature.Configuration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new GooFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("peencraft:goo", FEATURE,
				new LakeFeature.Configuration(BlockStateProvider.simple(PeencraftModBlocks.GOO.get()), BlockStateProvider.simple(Blocks.AIR)));
		PLACED_FEATURE = PlacementUtils.register("peencraft:goo", CONFIGURED_FEATURE,
